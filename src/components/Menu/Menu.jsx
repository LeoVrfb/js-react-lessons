...
<ul className="sous_menu_ul_2" id="sous_menu_ul_2">
  <li className="sous-items sous_items_2">
    <NavLink to="/react/usereducerlvl1" >usereducerlvl1</NavLink>
  </li>
  <li className="sous-items sous_items_2">
    <NavLink to="/react/usereducerlvl2" >usereducerlvl2</NavLink>
  </li>
  <li className="sous-items sous_items_2">
    useReducerLV3
    <ul className="sous_menu_ul_2" id="sous_menu_ul_2">
      <li className="sous-items sous_items_2">
        <NavLink to="/react/useredlv3" >useReducerLV3</NavLink>
      </li>
    </ul>
  </li>
</ul>
